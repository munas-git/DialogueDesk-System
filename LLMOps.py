...
class Agent():
    def __init__(self):
        self.tools = [
            ...
            Tool(
                ...
                description=(
                    ...
                    "(date, meeting_id)"
                    "An example meeting id for second meeting will be Meeting_2 The output will include transcript, ai_summary, key_points, and action_items fields."
        ...
        template = """
        You are an assistant helping with meeting information and complaints data.
        Your role is to help workers efficiently retrieve and analyze information from meetings.
        You can engage in minimal friendly greetings but should focus on business-related tasks.
        For non-meeting or non-complaints related questions, respond with:
