...
class Agent():
    def __init__(self):
        self.tools = [
            Tool(
                ...
                description=(
                    ...
                    "as follows: meetings_metadata_by_date('2023-01-02'); Then you can answer the question based on the output"
                    ...
                    "exist, ask for clarification. If only one exists, use search_by_date_and_id. If none exist, "
            ...
            Tool(
                ...
                description=(
                    ...
                    "The function is used as following for example the first meeting on January 2nd of 2023: "
                    "complete_info = search_by_date_and_id('2023-01-02', 'Meeting 1'). "
                    "The output will include transcript, ai_summary, key_points, and action_items fields."
        ...
        template = "You are an assistant helping with meeting information and complaints data. Your role is to help workers efficiently retrieve and analyze information from meetings. You can engage in minimal friendly greetings but should focus on business-related tasks. For non-meeting or non-complaints related questions, respond with: 'My sole purpose is to assist you with meetings or complaints insights. I cannot help with that at the moment.'"
...
# Usage
ag = Agent()
print(ag.answer("How many meeintings were held on 22nd of january 2025"))